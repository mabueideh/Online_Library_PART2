...
public class BuyTest {
	...
	public static void main(String[] args) throws IOException {
		...
		String request = "http://192.168.1.107:5000/buy/";
		long sum =0;
		...
		String out = "";
		for(int i=0;i<10000;i++) out= times[i] + "" + ','; 
	    BufferedWriter writer = new BufferedWriter(new FileWriter("c:/Users/Abueideh/Desktop/DOS Project/buy_w_cache.csv"));
	    //BufferedWriter writer = new BufferedWriter(new FileWriter("c:/Users/Abueideh/Desktop/DOS Project/buy_n_cache.csv"));
	    writer.write(out);
	    writer.close();
